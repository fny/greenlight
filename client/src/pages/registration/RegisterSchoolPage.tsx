          ...
          <>
            ...
            <p>
              <Trans id="RegisterSchoolPage.registration_instructions">
                Before you register your school with Greenlight, you will need to create an account. If you have an
                account, you can{' '}
          ...
          <>
            <p>
              <Trans id="RegisterSchoolPage.location_instructions">
                Fill out the form below to register your school. Welcome to Greenlight! Greenlight is brought to you by
                our partner Curamericas Global.
              </Trans>
            </p>
