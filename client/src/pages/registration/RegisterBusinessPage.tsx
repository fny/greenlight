          ...
          <>
            <p>
              <Trans id="LocationsNewPage.welcome">
                Welcome to Greenlight! Greenlight is brought to you by funding from the NC DHHS, Durham City and County,
                and our partner Curamericas Global.
              </Trans>
            </p>
            <p>
              <Trans id="LocationsNewPage.registration_instructions">
                Before you register your business or school with Greenlight, you will need to create an account. If you
                have an account, you can{' '}
                <Link href={paths.splashPath} style={{ display: 'inline' }}>
          ...
          <>
            <p>
              <Trans id="LocationsNewPage.location_instructions">
                Fill out the form below to create your new location. Greenlight is brought to you by funding from the NC
                DHHS, Durham City and County, and our partner Curamericas Global.
              </Trans>
            </p>
