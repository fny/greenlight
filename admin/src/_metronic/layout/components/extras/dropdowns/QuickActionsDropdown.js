...
export function QuickActionsDropdown() {
  const bgImage = toAbsoluteUrl("/images/bg/bg-2.jpg");
          ...
          <div className="topbar-item">
            ...
            >
              <span className="svg-icon svg-icon-xl svg-icon-primary">
                <SVG
                  src={toAbsoluteUrl("/images/svg/icons/images/Equalizer.svg")}
                />
              </span>
            </div>
          </div>
                ...
                <div className="col-6">
                  ...
                  >
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG
                        src={toAbsoluteUrl(
                          "/images/svg/icons/Shopping/Euro.svg"
                        )}
                      ></SVG>
                    </span>
                ...
                <div className="col-6">
                  ...
                  >
                    ...
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG
                        src={toAbsoluteUrl(
                          "/images/svg/icons/Communication/Mail-attachment.svg"
                        )}
                      ></SVG>
                    </span>
                    <span className="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">
                ...
                <div className="col-6">
                  ...
                  >
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG
                        src={toAbsoluteUrl(
                          "/images/svg/icons/Shopping/Box2.svg"
                        )}
                      ></SVG>
                    </span>
                    <span className="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">
