...
const links = [
  ...
  },
  {
    ...
    sublinks: [
      ...
      {
        title: "Notification Calendar",
        path: "/settings/notificaiton-calendar"
      }
    ]
  }
]
...
<span className="svg-icon menu-icon">
  <SVG src={toAbsoluteUrl("/images/svg/icons/Navigation/Arrow-from-left.svg")} />
</span>
*/

function renderLinks(links: HeaderLink[], layoutProps: any, getMenuItemActive: Function, isSublist: boolean = false) {
  ...
  return links.map(link => (
      <li
        ...
        aria-haspopup="true"
        className={`menu-item menu-item-submenu menu-item-rel ${getMenuItemActive(link.path)}`}>
        <NavLink className="menu-link menu-toggle" to={link.path}>
          {link.icon}
          <span className="menu-text">{link.title}</span>
          {
            isSublist ? <i className="menu-arrow"></i> : (layoutProps.rootArrowEnabled && (<i className="menu-arrow" />))
          }
        </NavLink>
        {
          Array.isArray(link.sublinks) &&
            <div className="menu-submenu menu-submenu-classic menu-submenu-left">
              <ul className="menu-subnav">
                {renderLinks(link.sublinks as HeaderLink[], layoutProps, getMenuItemActive, true)}
              </ul>
            </div>
        }
      </li>
...
export function HeaderMenu2(props: any) {
  const layoutProps: any = props.layoutProps
  const location = useLocation();

  function getMenuItemActive(url: string) {
  ...
  >
    <ul className={`menu-nav ${layoutProps.ulClasses}`}>
      {renderLinks(links, layoutProps, getMenuItemActive, false)}
    </ul>
  </div>;
}
          ...
          <ul className="menu-subnav">
            ...
            >
              <NavLink className="menu-link menu-toggle" to="/google-material/inputs">
                <span className="svg-icon menu-icon">
                  <SVG src={toAbsoluteUrl("/images/svg/icons/Design/PenAndRuller.svg")} />
                </span>
            ...
            >
              <NavLink className="menu-link menu-toggle" to="/google-material/surfaces">
                <span className="svg-icon menu-icon">
                  <SVG src={toAbsoluteUrl("/images/svg/icons/Layout/Layout-left-panel-1.svg")} />
                </span>
                <span className="menu-text">
                  Surfaces
                </span>
            ...
            >
              <NavLink className="menu-link menu-toggle" to="/google-material/feedback">
                <span className="svg-icon menu-icon">
                  <SVG src={toAbsoluteUrl("/images/svg/icons/General/Half-star.svg")} />
                </span>
                <span className="menu-text">
                  Feedback
                </span>
            ...
            >
              <NavLink className="menu-link menu-toggle" to="/google-material/data-displays">
                <span className="svg-icon menu-icon">
                  <SVG src={toAbsoluteUrl("/images/svg/icons/Devices/iMac.svg")} />
                </span>
                <span className="menu-text">
                  Data Display
                </span>
            ...
            >
              <NavLink className="menu-link menu-toggle" to="/google-material/utils">
                <span className="svg-icon menu-icon">
                  <SVG src={toAbsoluteUrl("/images/svg/icons/Tools/Swiss-knife.svg")} />
                </span>
                <span className="menu-text">
                  Utils
                </span>
            ...
            >
              <NavLink className="menu-link menu-toggle" to="/google-material/layout">
                <span className="svg-icon menu-icon">
                  <SVG src={toAbsoluteUrl("/images/svg/icons/Layout/Layout-top-panel-2.svg")} />
                </span>
                <span className="menu-text">
                  Layout
                </span>
